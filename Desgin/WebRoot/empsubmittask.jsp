...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function go(){
          ...
          window.location.href="${pageContext.request.contextPath}/task.do?flag=showSubmitTask&userId=${loginuser.userId}&pageNow="+pageNow;
        };
...
<div class="container clearfix">
    ...
    <center>
    <h4>每天任务提交信息</h4>
    <form action="${pageContext.request.contextPath}/task.do?flag=showQSubmitTask&userId=${loginuser.userId}" method="post">
    ...
    <td width=205px align="center">任务名称</td><td width=280px align="center">任务内容</td>
    ...
    <td width=100px align="center">任务状态</td><td width=100px align="center">完成度</td>
    ...
    <td align="center"><a href="${pageContext.request.contextPath}/task.do?flag=goEmpTaskPre&id=${task.id}" class="btn btn-primary btn2">提交任务</a>   
    </tr>
    </c:forEach>
    </table>
         <c:if test="${pageNow>1 }">
       <a href="${pageContext.request.contextPath}/task.do?flag=showSubmitTask&userId=${loginuser.userId}&pageNow=${pageNow-1 }"><input type="button" class="btn btn-primary btn2" value="上一页" /></a>  
    </c:if>
    <c:forEach var="i" begin="1" end="${pageCount}" >
        <a href="${pageContext.request.contextPath}/task.do?flag=showSubmitTask&userId=${loginuser.userId}&pageNow=${i}">[${i }]</a>
    </c:forEach>
    <c:if test="${pageNow<pageCount }">
      <a href="${pageContext.request.contextPath}/task.do?flag=showSubmitTask&userId=${loginuser.userId}&pageNow=${pageNow+1 }"><input type="button" class="btn btn-primary btn2" value="下一页" /></a>
    </c:if>
