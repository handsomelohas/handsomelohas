...
<div class="container clearfix">
    ...
    <div align="center">
    <h3>请你修改任务状态信息</h3>
    <form action="${pageContext.request.contextPath}/task.do?flag=empUpdateTaskType&id=${task.id}" method="post">
    <table>
    ...
    <input type="submit" class="btn btn-primary btn2" value="开始任务" />                 
    </form>
    </div>
    <!--/main-->
</div>
