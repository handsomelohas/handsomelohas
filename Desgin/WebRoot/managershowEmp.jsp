...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function go(){
          ...
          window.location.href="${pageContext.request.contextPath}/employee.do?flag=showEmp2&userId=${loginuser.userId}&pageNow="+pageNow;
        };
...
<div class="container clearfix">
    ...
    <center>
    <h4>职工信息检视</h4>
    <form action="${pageContext.request.contextPath}/employee.do?flag=showQEmp2" method="post">
    ...
    <td width=150px align="center">部门</td><td width=150px align="center">职位</td>
    <td width=200px align="center">入职日期</td><td width=100px align="center">权限</td>
    ...
    <td align="center"><a href="${pageContext.request.contextPath}/employee.do?flag=goupdateEmp&userId=${emp.userId}" class="btn btn-primary btn2">查看</a>   
    </tr>
    </c:forEach>
    </table>
    <c:if test="${pageNow>1 }">
       <a href="${pageContext.request.contextPath}/employee.do?flag=showEmp2&userId=${loginuser.userId}&pageNow=${pageNow-1 }"><input type="button" class="btn btn-primary btn2" value="上一页" /></a>  
    </c:if>
    <c:forEach var="i" begin="1" end="${pageCount}" >
        <a href="${pageContext.request.contextPath}/employee.do?flag=showEmp2&userId=${loginuser.userId}&pageNow=${i}">[${i }]</a>
    </c:forEach>
     <c:if test="${pageNow<pageCount }">
      <a href="${pageContext.request.contextPath}/employee.do?flag=showEmp2&userId=${loginuser.userId}&pageNow=${pageNow+1 }"><input type="button" class="btn btn-primary btn2" value="下一页" /></a>
    </c:if>
