            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/task.do?flag=showEmpTask"><i class="icon-font">&#xe004;</i>职工任务检视</a></li>
                        <li><a href="${pageContext.request.contextPath}/task.do?flag=showAudTask"><i class="icon-font">&#xe012;</i>职工任务评论</a></li>
                    </ul>
                </li>
            </ul>
        </div>
